...
function cargarEjemploProceso(){
document.getElementById('pasosBody').innerHTML = '';
agregarPaso('Recepcion de solicitud de credito', 10, 5, 5);
agregarPaso('Verificacion de identidad y documentos (KYC)', 20, 15, 15);
agregarPaso('Analisis crediticio y scoring', 30, 20, 10);
agregarPaso('Consulta a centrales de riesgo', 10, 60, 5);
agregarPaso('Comite de aprobacion de credito', 25, 120, 8);
agregarPaso('Formalizacion y firma de contrato', 20, 30, 5);
agregarPaso('Desembolso de fondos', 15, 10, 2);
agregarPaso('Seguimiento post-desembolso', 10, 5, 0);
}
...
if(!cargarPasosLocal()){ cargarEjemploProceso(); }
